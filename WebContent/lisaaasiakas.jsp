...
document.getElementById("etunimi").focus();//viedään kursori rekno-kenttään sivun latauksen yhteydess
...
function lisaaTiedot(){	
	...
	if(document.getElementById("etunimi").value.length<2){
		...
		ilmo="Liian lyhyt puhelinnumeroksi";		
	}else if(document.getElementById("sposti").value.length<10){
		ilmo="Liian lyhyt sähköpostiosoite";		
	}
	if(ilmo!=""){
	...
	fetch("myynti",{//Lähetetään kutsu backendiin
	      method: 'POST',
	      body:formJsonStr
	    })
